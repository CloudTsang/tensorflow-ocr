...
tf.app.flags.DEFINE_integer('charset_size', 3832, "Choose the first `charset_size` characters only.")
...
tf.app.flags.DEFINE_string('test_data_dir', './data/train/', 'the test dataset dir')
...
def build_graph(top_k):
    ...
    images = tf.placeholder(dtype=tf.float32, shape=[None, 64 * 64], name='input_image_batch')
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        conv3_1 = slim.conv2d(x_image, 64, [3, 3], 1, padding='SAME', scope='conv3_1')
    ...
    with tf.Session() as sess:
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                train_images_batch, train_labels_batch = fetch_data(128, DIR_IMAGE_TRAIN)
                ...
                if step % FLAGS.eval_steps == 1:
                    test_images_batch, test_labels_batch = fetch_data(128, DIR_IMAGE_TRAIN)
